...
namespace OpenWeatherAPI
{
    ...
    public class OpenWeatherProcessor
    {
        ...
        private OpenWeatherProcessor()
        {
            ...
            EndPoint = $"/weather?q=Shawinigan&appid={ApiKey}";
        }
        ...
        public async Task<OpenWeatherOneCallModel> GetOneCallAsync()
        {
            if (ApiKey != null)
            {
                ...
                EndPoint = $"/onecall?lat={Latitude}&lon={Longitude}&exclude=alerts&appid={ApiKey}";
            ...
            {
                throw new ArgumentException("Your ApiKey is null or empty");
            }
        ...
        public async Task<OWCurrentWeaterModel> GetCurrentWeatherAsync()
        {
            if (ApiKey != null)
            {
                ...
                EndPoint = $"/weather?lat={Latitude}&lon={Longitude}&appid={ApiKey}";
        ...
        private async Task<OpenWeatherOneCallModel> doOneCall()
        {
            ...
            {
                throw new AggregateException("Your ApiClient is not instanciate");
            }
            else
            {
